...
<span class="pill">📖 ALL SUBJECTS</span>
...
with st.sidebar:
    ...
    st.markdown("• Indian Constitution")
    st.markdown('<div class="divider"></div>', unsafe_allow_html=True)
...
if len(st.session_state.messages) == 0:
    ...
    <div class="welcome-box">
        ...
        <br>
        <div style="color:#7799aa; font-size:0.9em;">✦ Ask in English or Telugu ✦ Select subject in sidebar ✦</div>
    </div>
    """, unsafe_allow_html=True)
...
with col1:
    user_input = st.text_input("", placeholder="✦ Ask anything — JEE, NEET, UPSC, Inter...", label_visibility="collapsed")
with col2:
    send_button = st.button("🚀")

if send_button and user_input:
    st.session_state.messages.append({"role": "user", "content": user_input})
    st.markdown('<div class="user-bubble">🧑‍🎓 ' + user_input + '</div>', unsafe_allow_html=True)
